...
def compare_stocks(stock1_name, stock1_info, stock2_name, stock2_info):
    ...
    stock1_data = {
        ...
        "ROE (%)": round(stock1_info.get("returnOnEquity", "N/A")*100,2) if "returnOnEquity" in stock1_info else "N/A" ,
        "ROA (%)": round(stock1_info.get("returnOnAssets", "N/A")*100,2) if "returnOnAssets" in stock1_info else "N/A",
        "Net Profit Margin (%)": round(stock1_info.get("profitMargins", "N/A")*100,2) if "profitMargins" in stock1_info else "N/A",
    }
    ...
    stock2_data = {
        ...
        "ROE (%)": round(stock2_info.get("returnOnEquity", "N/A")*100,2) if "returnOnEquity" in stock2_info else "N/A" ,
        "ROA (%)": round(stock2_info.get("returnOnAssets", "N/A")*100,2) if "returnOnAssets" in stock2_info else "N/A",
        "Net Profit Margin (%)": round(stock2_info.get("profitMargins", "N/A")*100,2) if "profitMargins" in stock2_info else "N/A",
    }
